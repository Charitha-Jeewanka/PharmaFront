      ...
      <div>
        ...
        <div className="second-Content">
          <div className="background">
            <h2 className="second-Content-h2">
              {" "}
              Got a solid product? We tell your target audience that your exist
            </h2>
            <p>
        ...
        <div className="Content">
          <div className="Content-mid">
            ...
            <p className="Content-mid-p">
              {" "}
              Lorem Ipsum is simply dummy text of dummy text ever since the
        ...
        <div className="fourthContent">
          <div className="fourthContent-mid1">
            ...
            <p className="fourthContent-mid-p">
              {" "}
              Lorem Ipsum is simply dummy text of dummy text ever since the
              1500s, when an unknown printer took a galley of type and scrambled
              it to make a type specimen book. It has survived not only five
        ...
        <div className="firthContent">
          <div className="firthContent-mid1">
            ...
            <p className="firthContent-mid-p">
              {" "}
              Lorem Ipsum is simply dummy text of dummy text ever since the
              1500s, when an unknown printer took a galley of type and scrambled
              it to make a type specimen book. It has survived not only five
